...
public:
	...
	virtual void ann_search(ANNdist, ann_search_ctx &ctx) = 0;		// tree search
	virtual void ann_pri_search(ANNdist, annkPriSearch_ctx &ctx) = 0;	// priority search
	virtual void ann_FR_search(ANNdist, annkFRSearch_ctx &ctx) = 0;	// fixed-radius search
...
public:
	...
	virtual void ann_search(ANNdist, ann_search_ctx &ctx);			// standard search
	virtual void ann_pri_search(ANNdist, annkPriSearch_ctx &ctx);		// priority search
	virtual void ann_FR_search(ANNdist, annkFRSearch_ctx &ctx);		// fixed-radius search
};

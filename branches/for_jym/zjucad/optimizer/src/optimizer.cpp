...
namespace zjucad {
  ...
  {
    math2hj_func<double,int32_t, RAW> hj_func(&f);
    zjucad::matrix::matrix<double> residual(hj_func.dim_of_f(),1);
    return optimize(hj_func, x, residual,pt);
  }

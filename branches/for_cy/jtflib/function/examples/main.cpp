...
//		return 0;
//	}
//  virtual int hes(const value_type * x, value_type * val, int_type *ptr = 0, int_type * idx=0, func_ctx *ctx = 0)const {
//	ptr[1] = ptr[0]	 + 1;
//	val[ptr[0]+0] = -10 * cos(x[0]);
//	idx[ptr[0]+0] = 0;
...
//	auto_ptr<jtf::function::function> sf0(f0/10.0);
...
//	vector<jtf::function::function *> cf0(2);
//	cf0[0] = sf0.get();
//	cf0[1] = &f1;
//	auto_ptr<jtf::function::function> cf(new_catenated_function<fun1::value_type, fun1::int_type>(cf0));
...
//jtf::function::function *new_func(void)
//{
...
//{
//	boost::shared_ptr<jtf::function::function> cf(new_func());
...
//	const jtf::function::function *f = &f0;

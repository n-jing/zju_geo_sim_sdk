...
namespace jtf{
  namespace mesh{
    ...
    /// @return return 0 if fine or non-zeros
    ///
    int save_obj(const char * filename, const matrixst & mesh, const matrixd & node);
    ...
    ///
    int tet_mesh_read_from_zjumat(const char *path,  matrixd *node = 0,
    ...
    /// @return 0 if succeed, or non-zeros
    ///
    int tet_mesh_write_to_zjumat(const char *path,   const matrixd *node = 0,
    ...
    /// @return 0 if succeed, or non-zeros
    ///
    int tet_mesh_read_from_vtk(const char *path, matrixd *node = 0,
                               matrixst *tet = 0);
